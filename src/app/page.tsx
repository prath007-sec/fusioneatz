  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen flex-col items-center overflow-hidden px-4 pt-16 text-center">
        ...
        {/* Centered content — grows to fill space, badges+bowl anchored together */}
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <div className="relative mt-12">
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center gap-4 text-sm text-zinc-400"
            >
            ...
            {/* Spinning bowl — absolute, always right below badges */}
            <motion.div
